...
echo "LD  IPadDisplay"
clang "${CFLAGS[@]}" -fuse-ld=ld -framework UIKit -framework Foundation -framework CoreGraphics -framework AudioToolbox -framework AVFoundation -framework CoreMedia -framework QuartzCore -lobjc \
