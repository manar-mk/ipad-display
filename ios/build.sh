...
# home screen / spotlight / settings icons (generated by tools/make-icons.js)
cp "$SRC"/Icon-*.png "$APP/" 2>/dev/null && echo "ICONS $(ls "$APP"/Icon-*.png | wc -l) files" || echo "ICONS none (run node tools/make-icons.js)"
